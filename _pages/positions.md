...
- We provide training and research opportunities to students who are interested in speech processing and want to collaborate with us.
  ...
  - The collaboration is based on a one-hour WAVLab collaborator meeting every Thursday. That hour is shared by everyone who attends, so your own share is the hour divided by the number of participants: usually 5 to 10 people join, which means about 5 to 10 minutes each.
  - That is basically the time we can commit to, and it is difficult to spend more time than that, although more time becomes possible depending on how your research progresses.
